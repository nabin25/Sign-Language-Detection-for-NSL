...
model_c.load_state_dict(torch.load('../hand_sign_classifier_final1.pth', map_location=torch.device('cpu')))
model_c.eval()

model_v = HandSignClassifier(num_classes=13)
model_v.load_state_dict(torch.load("../hand_sign_classifier_best_vowel1.pth", map_location=torch.device('cpu')))
model_v.eval()
